		...
		return (
			...
			<div className="Map">
				...
				<div className="filter">
					...
					<label for="likeyCheck">
						<FontAwesomeIcon icon={faStar} color="yellow" id="likey"/>
						<input type="radio" id="likeyCheck" name="filter"/> 관심매장 보기
					</label>

					<label for="naechelinCheck">
						<FontAwesomeIcon icon={faStar} color="red" id="naecheliin"/>
						<input type="radio" id="naechelinCheck" name="filter"/> 내슐랭보기
					</label>
					<label for="guideCheck">
						<FontAwesomeIcon icon={faBook} color="rgb(100, 236, 159)" id="guide"/>
						<input type="radio" id="guideCheck" name="filter"/> 내슐랭 가이드 보기
					</label>
				</div>
